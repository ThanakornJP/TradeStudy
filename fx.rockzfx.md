...
3. example
    - ![key-level-ex1](key-level-ex1.png)
        - ![key-level-ex1-2](key-level-ex1-2.png)
    - ![key-level-ex2](key-level-ex2.png)
        - ![key-level-ex2-2](key-level-ex2-2.png)
        - bull tryna push up but fail by leaving its wick at top
    - ![key-level-ex3](key-level-ex3.png)
        - ![key-level-ex3-2](key-level-ex3-2.png)
